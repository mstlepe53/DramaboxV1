/**
 * Watch TV Page - TMDB + VidNest embed
 * Route: /watch/tv/:id/:season/:episode
 */
import { useParams, Link, useNavigate } from 'react-router-dom';
import { useState, useEffect } from 'react';
import { Play, SkipBack, SkipForward, AlertCircle, Info, Share2, Heart, Bookmark, LightbulbOff, Search } from 'lucide-react';
import { useTVDetailsQuery, useTVSeasonQuery } from '../hooks/useQueries';
import { FALLBACK_IMAGE, posterUrl, getTVEmbedUrl } from '../services/tmdb';
...
export default function WatchTV() {
  ...
  const embedUrl = id ? getTVEmbedUrl(id, season, episode) : '';
          ...
          <div className="w-full bg-black rounded-xl overflow-hidden relative aspect-video">
            {iframeError ? (
              <div className="absolute inset-0 flex flex-col items-center justify-center text-white gap-3 p-6 text-center">
                ...
                <p className="text-sm text-gray-200 max-w-md">The player failed to load. Try refreshing or a different episode.</p>
