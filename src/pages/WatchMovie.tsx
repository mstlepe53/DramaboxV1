/**
 * Watch Movie Page - TMDB + VidNest embed
 */
import { useParams, Link, useNavigate } from 'react-router-dom';
import { useState, useEffect } from 'react';
import { Play, AlertCircle, Info, Share2, Heart, Bookmark, Flag, LightbulbOff } from 'lucide-react';
import { useMovieDetailsQuery } from '../hooks/useQueries';
import { FALLBACK_IMAGE, posterUrl, getMovieEmbedUrl } from '../services/tmdb';
...
export default function WatchMovie() {
  ...
  const embedUrl = id ? getMovieEmbedUrl(id) : '';
          ...
          <div className="w-full bg-black rounded-xl overflow-hidden relative aspect-video">
            {loading ? (
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center text-white gap-3 p-6 text-center">
                ...
                <p className="text-sm text-gray-200 max-w-md">The player failed to load. Try refreshing.</p>
